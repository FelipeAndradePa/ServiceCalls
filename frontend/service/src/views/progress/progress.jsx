                    ...
                    <table className='w-5/6 divide-y divide-gray-200'>
                        <thead>
                            <tr>
                                ...
                                <th className='py-3 px-6 text-left bg-gray-100'>Hora</th>
                                <th className='py-3 px-6 text-left bg-gray-100'>Empresa</th>
                                <th className='w-1/4 py-3 px-6 text-left bg-gray-100'>Nome</th>
                                <th className='w-1/2 py-3 px-6 text-left bg-gray-100'>Descrição</th>
                        ...
                        <tbody className='bg-white divide-y divide-gray-200'> 
                            <tr>
                                ...
                                <th className='py-4 px-6'>18:58</th>
                                ...
                                <th className='py-4 px-6'>Em progresso</th>
                            </tr>
                        </tbody>
                    </table>
                </div>
